...
export function BehaviourCoursePage() {
  ...
  const total = BEHAVIOUR_COURSE.modules.length
  ...
  return (
    <Layout>
      ...
      {/* Header */}
      <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-xl p-6 mb-6">
        ...
        <h1 className="text-2xl font-black text-white mb-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>
          {BEHAVIOUR_COURSE.title}
        </h1>
        <p className="text-sm text-white/80 mb-4">{BEHAVIOUR_COURSE.description}</p>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                {isUnlocked && (
                  <Link
                    to={`/courses/behaviour/${mod.id}`}
                    className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors"
